...
# curve security is AES equivalent, rounded up.
    ...
    if x==17:
        curveset("secp256k1","56","256","1","1","NOT_SPECIAL","0","WEIERSTRASS","0","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==18:
    ...
    if x==26:
        curveset("bn254","56","254","1",["-1","-1"],"NOT_SPECIAL","0","WEIERSTRASS","0","BN","D_TYPE","NEGATIVEX","66","128")
    ...
    if x==30:
        curveset("fp256bn","56","256","1",["1","1"],"NOT_SPECIAL","0","WEIERSTRASS","0","BN","M_TYPE","NEGATIVEX","66","128")
        pfcurve_selected=True
    if x==31:
        curveset("fp512bn","60","512","1",["1","1"],"NOT_SPECIAL","0","WEIERSTRASS","0","BN","M_TYPE","POSITIVEX","130","128")
        pfcurve_selected=True
# https://eprint.iacr.org/2017/334.pdf
    ...
    if x==33:
        curveset("bn462","60","462","1",["1","1"],"NOT_SPECIAL","1","WEIERSTRASS","0","BN","D_TYPE","POSITIVEX","118","128")
        pfcurve_selected=True
