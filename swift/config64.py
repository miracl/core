...
# curve security is AES equivalent, rounded up.
	...
	if x==20:
		...
		pfcurve_selected=True
	if x==21:
		curveset("bls12383","58","383","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","65","128")
		pfcurve_selected=True

	if x==22:
		curveset("bls12381","58","381","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","65","128")
		pfcurve_selected=True
...
# https://eprint.iacr.org/2017/334.pdf
	if x==25:
		curveset("bls12461","60","461","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","78","128")
		pfcurve_selected=True
	...
	if x==27:
		curveset("bls24479","56","479","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","49","192")
		pfcurve_selected=True

	if x==28:
		curveset("bls48556","58","556","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","32","256")
		pfcurve_selected=True

	if x==29:
		curveset("bls48581","60","581","3","NOT_SPECIAL","10","WEIERSTRASS","BLS","D_TYPE","NEGATIVEX","33","256")
		pfcurve_selected=True
