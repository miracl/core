...
if testing :
	os.system("swiftc -I. -L. -lcore -led25519 -lnist256 -lgoldilocks -lbn254 -lbls383 -lbls24 -lbls48 -lrsa2048 TestALL.swift ")
	os.system("swiftc -I. -L. -lcore -lbn254 -lbls383 -lbls24 -lbls48 TestBLS.swift")
	os.system("swiftc -I. -L. -lcore -led25519 -lnist256 -lgoldilocks -lbn254 -lbls383 -lbls24 -lbls48 -lrsa2048 BenchtestALL.swift ")
