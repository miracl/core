...
// Mode 0
    var mode=0;
    print("\nMode 0");
    var skR=decode_hex("d3c8ca6516cd4cc75f66210c5a49d05381bfbfc0de090c19432d778ea4599829")
    var skE=decode_hex("b9d453d3ec0dbe59fa4a193bde3e4ea17f80c9b2fa69f2f3e029120303b86885")
    var pkR=decode_hex("10b2fc2332b75206d2c791c3db1094dfd298b6508138ce98fec2c0c7a4dbc408")
...
// Mode 2
    ...
    var skS=decode_hex("55799581f14ec785dbaa11857700adf78f842a51b5ae6a4b4e5a4d99c66e5793")
    ...
    var pkS=decode_hex("2bba172f178cf852e8670e574fdcdd62d8dcfa063548d3424d84f3e403f4e64c")

    Z=c25519.HPKE.AUTHENCAP(config_id,skE,&pkE,&pkR,&skS)
    print("pkE= ",terminator:""); printBinary(pkE)
    print("Encapsulated Z= ",terminator:""); printBinary(Z)

    Z=c25519.HPKE.AUTHDECAP(config_id,&pkE,skR,&pkS)
    print("Decapsulated Z= ",terminator:""); printBinary(Z)
...
// Mode 0
    var mode=0;
    print("\nMode 0");
    var skR=decode_hex("01b3e33a2cf926ef496fff7e86a3743c23a9797c3bf99af8366ce22b3b0940fff1f1934e4d0bd539e130bdc3ff5991d37bdf45fc73529fe9a2e00e138d376610c26a")
    var skE=decode_hex("00252116681dacf4e707e9881aff5496942a36e74185347df21ab9d647dfe2a910e325b027ac3114335c038589d86a6a1a665498a5a6ea687ad5ddbd4258f273e2e7")
    var pkR=decode_hex("")
...
// Mode 2
    ...
    var skS=decode_hex("01dd6f1ea81fbcb28da541d801edfa89e5648cc809b42cbe8b503caf6d7c5026a8bd9ea058951b8b9eee10e095a1865ef26ef247a3e62c25062f3877ff0627711eca")
    ...
    var pkS=decode_hex("")

    Z=nist521.HPKE.AUTHENCAP(config_id,skE,&pkE,&pkR,&skS)
    print("pkE= ",terminator:""); printBinary(pkE)
    print("Encapsulated Z= ",terminator:""); printBinary(Z)

    Z=nist521.HPKE.AUTHDECAP(config_id,&pkE,skR,&pkS)
    print("Decapsulated Z= ",terminator:""); printBinary(Z)
