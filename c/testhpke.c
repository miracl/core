...
// Mode 0
    ...
    HPKE_C25519_Encap(config_id,NULL,&skE,&Z,&pkE,&pkR);
    ...
    HPKE_C25519_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,NULL,NULL,NULL);
...
// Mode 1
    ...
    HPKE_C25519_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,&psk,&pskID,NULL);
...
// Mode 2
    ...
    HPKE_C25519_AuthEncap(config_id,NULL,&skE,&Z,&pkE,&pkR,&skI);

    printf("pkE= "); OCT_output(&pkE); 
    printf("Encapsulated Z= "); OCT_output(&Z);

    HPKE_C25519_AuthDecap(config_id,&Z,&pkE,&skR,&pkI);
    printf("Decapsulated Z= "); OCT_output(&Z);

    HPKE_C25519_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,NULL,NULL,&pkI);
...
// Mode 3
    ...
    HPKE_C25519_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,&psk,&pskID,&pkI);
...
// Mode 0
    ...
    HPKE_NIST521_Encap(config_id,NULL,&skE,&Z,&pkE,&pkR);
    ...
    HPKE_NIST521_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,NULL,NULL,NULL);
...
// Mode 1
    ...
    HPKE_NIST521_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,&psk,&pskID,NULL);
...
// Mode 2
    ...
    HPKE_NIST521_AuthEncap(config_id,NULL,&skE,&Z,&pkE,&pkR,&skI);

    printf("pkE= "); OCT_output(&pkE); 
    printf("Encapsulated Z= "); OCT_output(&Z);

    HPKE_NIST521_AuthDecap(config_id,&Z,&pkE,&skR,&pkI);
    printf("Decapsulated Z= "); OCT_output(&Z);

    HPKE_NIST521_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,NULL,NULL,&pkI);
...
// Mode 3
    ...
    HPKE_NIST521_KeySchedule(config_id,&KEY,&NONCE,mode,&pkR,&Z,&pkE,&INFO,&psk,&pskID,&pkI);
