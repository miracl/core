...
def curveset(nbt,tf,tc,base,m8,mt,qi,ct,pf,stw,sx,g2,ab,cs) :
    ...
    replace(fnamec,"INLINE_MUL",inline_mul2(nlen,bd))    #for some architectures inline_mul1() and inline_redc1() may be faster
    replace(fnamec,"INLINE_SQR",inline_sqr(nlen,bd))
    replace(fnamec,"INLINE_REDC",inline_redc2(nlen,bd))
...
# curve security is AES equiavlent, rounded up.
    ...
    if x==1:
        curveset("255","F25519","ED25519","56","2","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True
    if x==2:
        curveset("255","F25519","C25519","56","2","PSEUDO_MERSENNE","0","MONTGOMERY","NOT_PF","","","","","128")
        curve_selected=True
    if x==3:
        curveset("256","NIST256","NIST256","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    if x==4:
        curveset("256","BRAINPOOL","BRAINPOOL","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    if x==5:
        curveset("256","ANSSI","ANSSI","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True

    if x==6:
        curveset("336","HIFIVE","HIFIVE","60","2","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","192")
        curve_selected=True
    if x==7:
        curveset("448","GOLDILOCKS","GOLDILOCKS","58","1","GENERALISED_MERSENNE","0","EDWARDS","NOT_PF","","","","","256")
        curve_selected=True
    if x==8:
        curveset("384","NIST384","NIST384","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","192")
        curve_selected=True
    if x==9:
        curveset("414","C41417","C41417","60","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","256")
        curve_selected=True
    if x==10:
        curveset("521","NIST521","NIST521","60","1","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT_PF","","","","","256")
        curve_selected=True

    if x==11:
        curveset("256","F256PMW","NUMS256W","56","1","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    if x==12:
        curveset("256","F256PME","NUMS256E","56","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True
    if x==13:
        curveset("384","F384PM","NUMS384W","56","1","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT_PF","","","","","192")
        curve_selected=True
    if x==14:
        curveset("384","F384PM","NUMS384E","56","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","192")
        curve_selected=True
    if x==15:
        curveset("512","F512PM","NUMS512W","56","1","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT_PF","","","","","256")
        curve_selected=True
    if x==16:
        curveset("512","F512PM","NUMS512E","56","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","256")
        curve_selected=True

    if x==17:
        curveset("256","SECP256K1","SECP256K1","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    if x==18:
        curveset("256","SM2","SM2","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True

    if x==19:
        curveset("255","F25519","C13318","56","2","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True

    if x==20:
        curveset("255","JUBJUB","JUBJUB","56","32","NOT_SPECIAL","5","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True

    if x==21:
        curveset("448","GOLDILOCKS","X448","58","1","GENERALISED_MERSENNE","0","MONTGOMERY","NOT_PF","","","","","256")
        curve_selected=True

    if x==22:
        curveset("160","SECP160R1","SECP160R1","56","1","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    if x==23:
        curveset("251","C1174","C1174","56","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True
    if x==24:
        curveset("166","C1665","C1665","60","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True


    if x==25:
        curveset("254","BN254","BN254","56","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","D_TYPE","NEGATIVEX","71","66","128")
        pfcurve_selected=True
    if x==26:
        curveset("254","BN254CX","BN254CX","56","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","D_TYPE","NEGATIVEX","76","66","128")
        pfcurve_selected=True
    if x==27:
        curveset("383","BLS12383","BLS12383","58","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","68","65","128")
        pfcurve_selected=True

    if x==28:
        curveset("381","BLS12381","BLS12381","58","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","NEGATIVEX","69","65","128")
        pfcurve_selected=True


    if x==29:
        curveset("256","FP256BN","FP256BN","56","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","M_TYPE","NEGATIVEX","83","66","128")
        pfcurve_selected=True
    if x==30:
        curveset("512","FP512BN","FP512BN","60","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","M_TYPE","POSITIVEX","172","130","128")
        pfcurve_selected=True
# https://eprint.iacr.org/2017/334.pdf
    if x==31:
        curveset("461","BLS12461","BLS12461","60","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","NEGATIVEX","79","78","128")
        pfcurve_selected=True

    if x==32:
        curveset("462","BN462","BN462","60","1","NOT_SPECIAL","1","WEIERSTRASS","BN_CURVE","D_TYPE","POSITIVEX","125","118","128")
        pfcurve_selected=True

    if x==33:
        curveset("479","BLS24479","BLS24479","56","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","52","49","192")
        pfcurve_selected=True

    if x==34:
        curveset("556","BLS48556","BLS48556","58","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","35","32","256")
        pfcurve_selected=True


    if x==35:
        curveset("581","BLS48581","BLS48581","60","1","NOT_SPECIAL","10","WEIERSTRASS","BLS_CURVE","D_TYPE","NEGATIVEX","36","33","256")
        pfcurve_selected=True
