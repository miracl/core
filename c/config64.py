...
# curve security is AES equiavlent, rounded up.
	...
	if x==1:
		curveset("255","25519","ED25519","56","5","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==2:
		curveset("255","25519","C25519","56","5","PSEUDO_MERSENNE","0","MONTGOMERY","NOT","","","","","128")
		curve_selected=True
	if x==3:
	...
	if x==6:
		curveset("336","HIFIVE","HIFIVE","60","5","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==7:
		curveset("448","GOLDILOCKS","GOLDILOCKS","58","7","GENERALISED_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==8:
		curveset("384","NIST384","NIST384","56","7","NOT_SPECIAL","0","WEIERSTRASS","NOT","","","","","128")
		curve_selected=True
	if x==9:
		curveset("414","C41417","C41417","60","7","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==10:
		curveset("521","NIST521","NIST521","60","7","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","","","","","128")
		curve_selected=True

	if x==11:
		curveset("256","256PMW","NUMS256W","56","3","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","","","","","128")
		curve_selected=True
	if x==12:
		curveset("256","256PME","NUMS256E","56","3","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==13:
		curveset("384","384PM","NUMS384W","56","3","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","","","","","128")
		curve_selected=True
	if x==14:
		curveset("384","384PM","NUMS384E","56","3","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
	if x==15:
		curveset("512","512PM","NUMS512W","56","7","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","","","","","128")
		curve_selected=True
	if x==16:
		curveset("512","512PM","NUMS512E","56","7","PSEUDO_MERSENNE","0","EDWARDS","NOT","","","","","128")
		curve_selected=True
...
# https://eprint.iacr.org/2017/334.pdf
	...
	if x==26:
		curveset("462","BN462","BN462","60","3","NOT_SPECIAL","1","WEIERSTRASS","BN","D_TYPE","POSITIVEX","125","118","128")
		pfcurve_selected=True
