...
static void mpin_hash(int sha, FP4_YYY *f, ECP_ZZZ *P, octet *w)
{
    ...
    octet T={6 * MODBYTES_XXX,sizeof(t),t};
    int hlen = sha;
    ...
    BIG_XXX_toBytes(&T.val[5 * MODBYTES_XXX], y);
