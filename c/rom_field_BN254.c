...
const BIG_256_13 ROI_BN254= {0x12,0x0,0x0,0x0,0x1A70,0x9,0x0,0x0,0x100,0x309,0x2,0x0,0x1800,0x1A26,0x6E8,0x0,0x0,0x412,0x8D9,0x4A};
...
const BIG_256_13 CRu_BN254= {0x7,0x0,0x0,0x0,0xCD8,0x3,0x0,0x0,0x900,0x1248,0x0,0x0,0x400,0x19B1,0x126,0x0,0x0,0x0,0x0,0x0};
...
const BIG_256_13 SQRTm3_BN254= {0x4,0x0,0x0,0x0,0xC0,0x3,0x0,0x0,0xF00,0x1E78,0x0,0x0,0x1000,0x6C4,0x49B,0x0,0x0,0x412,0x8D9,0x4A};
#endif

#if CHUNK==32
// Base Bits= 28
const BIG_256_28 Modulus_BN254= {0x13,0x0,0x13A7,0x0,0x86121,0x8000000,0x1BA344D,0x4000000,0x5236482,0x2};
const BIG_256_28 ROI_BN254= {0x12,0x0,0x13A7,0x0,0x86121,0x8000000,0x1BA344D,0x4000000,0x5236482,0x2};
...
const BIG_256_28 CRu_BN254= {0x7,0x8000000,0x6CD,0x0,0x24909,0x4000000,0x49B362,0x0,0x0,0x0};
...
const BIG_256_28 SQRTm3_BN254= {0x4,0x0,0x60C,0x0,0x3CF0F,0x0,0x126CD89,0x4000000,0x5236482,0x2};
#endif

#if CHUNK==64
// Base Bits= 56
const BIG_256_56 Modulus_BN254= {0x13L,0x13A7L,0x80000000086121L,0x40000001BA344DL,0x25236482L};
const BIG_256_56 ROI_BN254= {0x12L,0x13A7L,0x80000000086121L,0x40000001BA344DL,0x25236482L};
...
const BIG_256_56 CRu_BN254= {0x80000000000007L,0x6CDL,0x40000000024909L,0x49B362L,0x0L};
...
const BIG_256_56 SQRTm3_BN254= {0x4L,0x60CL,0x3CF0FL,0x4000000126CD89L,0x25236482L};
#endif
