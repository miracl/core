...
static void mpin_hash(int sha, FP16_YYY *f, ECP_ZZZ *P, octet *w)
{
    ...
    octet T={18 * MODBYTES_XXX,sizeof(t),t};
    int hlen = sha;

    FP_YYY_redc(x, &(f->a.a.a.a));
    BIG_XXX_toBytes(&T.val[0], x);
    FP_YYY_redc(x, &(f->a.a.a.b));
    BIG_XXX_toBytes(&T.val[MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->a.a.b.a));
    BIG_XXX_toBytes(&T.val[2 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->a.a.b.b));
    BIG_XXX_toBytes(&T.val[3 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->a.b.a.a));
    BIG_XXX_toBytes(&T.val[4 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->a.b.a.b));
    BIG_XXX_toBytes(&T.val[5 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->a.b.b.a));
    BIG_XXX_toBytes(&T.val[6 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->a.b.b.b));
    BIG_XXX_toBytes(&T.val[7 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->b.a.a.a));
    BIG_XXX_toBytes(&T.val[8 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->b.a.a.b));
    BIG_XXX_toBytes(&T.val[9 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->b.a.b.a));
    BIG_XXX_toBytes(&T.val[10 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->b.a.b.b));
    BIG_XXX_toBytes(&T.val[11 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->b.b.a.a));
    BIG_XXX_toBytes(&T.val[12 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->b.b.a.b));
    BIG_XXX_toBytes(&T.val[13 * MODBYTES_XXX], x);

    FP_YYY_redc(x, &(f->b.b.b.a));
    BIG_XXX_toBytes(&T.val[14 * MODBYTES_XXX], x);
    FP_YYY_redc(x, &(f->b.b.b.b));
    BIG_XXX_toBytes(&T.val[15 * MODBYTES_XXX], x);

    ECP_ZZZ_get(x, y, P);
    BIG_XXX_toBytes(&T.val[16 * MODBYTES_XXX], x);
    BIG_XXX_toBytes(&T.val[17 * MODBYTES_XXX], y);
