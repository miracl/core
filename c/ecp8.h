 ...
 */
extern void ECP8_ZZZ_toOctet(octet *S, ECP8_ZZZ *P, bool c);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP8_ZZZ_setx(ECP8_ZZZ *P, FP8_YYY *x, int s);
 ...
 */
extern void ECP8_ZZZ_hap2point(ECP8_ZZZ *Q, BIG_XXX  x);
 ...
 */
extern void ECP8_ZZZ_map2point(ECP8_ZZZ *Q, FP8_YYY *x);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP8_ZZZ_generator(ECP8_ZZZ *G);
