 ...
 */
extern void KYBER_CPA_encrypt(byte *coins,octet *PK,byte *SS,octet *CT);
 ...
 */
extern void KYBER_CPA_decrypt(octet *PK,octet *CT,byte *SS);
 ...
 */
extern void KYBER_CCA_encrypt(byte *r32,octet *PK,byte *SS,octet *CT);
 ...
 *
	...
	@param SS output session key 
 */
extern void KYBER_CCA_decrypt(octet *PK,octet *CT,byte *SS);
