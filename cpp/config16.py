...
# curve security is AES equivalent, rounded up.
    ...
    if x==1:
        curveset("255","F25519","ED25519","13","2","1","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True
    if x==2:
        curveset("256","F256PME","NUMS256E","13","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT_PF","","","","","128")
        curve_selected=True

    if x==3:
        curveset("160","SECP160R1","SECP160R1","13","1","3","NOT_SPECIAL","0","WEIERSTRASS","NOT_PF","","","","","128")
        curve_selected=True
    ...
    if x==5:
        curveset("254","BN254CX","BN254CX","13","1",["-1","0","-1"],"NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","D_TYPE","NEGATIVEX","76","66","128")
        pfcurve_selected=True
