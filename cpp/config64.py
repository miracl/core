...
# curve security is AES equivalent, rounded up.
    ...
    if x==13:
        ...
        curve_selected=True
    if x==14:
        curveset("384","F384PM","NUMS384E","58","1","0","PSEUDO_MERSENNE","0","EDWARDS","1","NOT_PF","","","","","192")
        curve_selected=True
    if x==15:
...
#    if x==pf+6:
#        curveset("443","BLS12443","BLS12443","60","1",["1","1","0"],"NOT_SPECIAL","0","WEIERSTRASS","0","BLS12_CURVE","M_TYPE","POSITIVEX","78","75","128")
#        pfcurve_selected=True
