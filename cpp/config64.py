...
# curve security is AES equivalent, rounded up.
    ...
    if x==25:
        curveset("254","BN254","BN254","56","1","-1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","D_TYPE","NEGATIVEX","71","66","128")
        pfcurve_selected=True
    if x==26:
        curveset("254","BN254CX","BN254CX","56","1","-1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","D_TYPE","NEGATIVEX","76","66","128")
        pfcurve_selected=True
    if x==27:
        curveset("383","BLS12383","BLS12383","58","1","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","68","65","128")
        pfcurve_selected=True

    if x==28:
        curveset("381","BLS12381","BLS12381","58","1","-3","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","NEGATIVEX","69","65","128")
        pfcurve_selected=True

    if x==29:
        curveset("256","FP256BN","FP256BN","56","1","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","M_TYPE","NEGATIVEX","83","66","128")
        pfcurve_selected=True
    if x==30:
        curveset("512","FP512BN","FP512BN","60","1","1","NOT_SPECIAL","0","WEIERSTRASS","BN_CURVE","M_TYPE","POSITIVEX","172","130","128")
        pfcurve_selected=True
    if x==31:
        curveset("461","BLS12461","BLS12461","60","1","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","NEGATIVEX","79","78","128")
        pfcurve_selected=True

    if x==32:
        curveset("462","BN462","BN462","60","1","1","NOT_SPECIAL","1","WEIERSTRASS","BN_CURVE","D_TYPE","POSITIVEX","125","118","128")  #was 0 M_TYPE
        pfcurve_selected=True
    if x==33:
        curveset("479","BLS24479","BLS24479","56","1","1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","52","49","192")
        pfcurve_selected=True

    if x==34:
        curveset("556","BLS48556","BLS48556","58","1","-1","NOT_SPECIAL","0","WEIERSTRASS","BLS_CURVE","M_TYPE","POSITIVEX","35","32","256")
        pfcurve_selected=True

    if x==35:
        curveset("581","BLS48581","BLS48581","60","1","2","NOT_SPECIAL","10","WEIERSTRASS","BLS_CURVE","D_TYPE","NEGATIVEX","36","33","256")
        pfcurve_selected=True
