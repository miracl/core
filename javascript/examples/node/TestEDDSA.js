...
// Generate Key pair S/W 
    ...
    if (prehash) {
        ...
        ctx.EDDSA.SIGNATURE(true,D, Q, null,HM, SIG);
    } else {
        ctx.EDDSA.SIGNATURE(false,D, Q, null,M, SIG);
    }
...
// Generate Key pair S/W 
    ...
    if (prehash) {
        ...
        ctx.EDDSA.SIGNATURE(true,D, Q, CONTEXT,HM, SIG);
    } else {
        ctx.EDDSA.SIGNATURE(false,D, Q, CONTEXT,M, SIG);
    }
    console.log("Signature= 0x"+ctx.EDDSA.bytestostring(SIG));
