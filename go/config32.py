...
def curveset(tc,base,nbt,m8,rz,mt,qi,ct,ca,pf,stw,sx,g2,ab,cs) :
    ...
    os.system(copytext+"EDDSA.go "+fpath+"EDDSA.go")
    ...
    os.system(copytext+"ROM_"+tcu+"_32.go "+fpath+"ROM.go")
    ...
    replace(fpath+"EDDSA.go","XXX",tcu)
    replace(fpath+"EDDSA.go","Xxx",tc)
...
os.system(copytext+ "DILITHIUM.go core"+slashtext+".")
