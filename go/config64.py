...
# curve security is AES equiavlent, rounded up.
	...
	if x==6:
		...
		curve_selected=True
	if x==7:
		curveset("GOLDILOCKS","58","448","1","GENERALISED_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","256")
		curve_selected=True
	if x==8:
	...
	if x==15:
		...
		curve_selected=True
	if x==16:
		curveset("NUMS512E","60","512","1","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","256")
		curve_selected=True
...
# https://eprint.iacr.org/2017/334.pdf
	...
	if x==34:
		curveset("BLS48556","58","556","1","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","35","42","256")
		pfcurve_selected=True
