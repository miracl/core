...
# curve security is AES equiavlent, rounded up.
	...
	if x==26:
		...
		pfcurve_selected=True
	if x==27:
		curveset("BLS12383","58","383","1","1","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","68","65","128")
		pfcurve_selected=True

	if x==28:
		curveset("BLS12381","58","381","1","-3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","69","65","128")
		pfcurve_selected=True
...
# https://eprint.iacr.org/2017/334.pdf
	...
	if x==34:
		curveset("BLS48556","58","556","1","-1","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","35","42","256")
		pfcurve_selected=True
