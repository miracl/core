...
# curve security is AES equiavlent, rounded up.
	...
	if x==20:
		...
		pfcurve_selected=True
	if x==21:
		curveset("BLS12383","58","383","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","68","65","128")  # change to 58
		pfcurve_selected=True

	if x==22:
		curveset("BLS12381","58","381","3","NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","69","65","128")  # change to 58
		pfcurve_selected=True
