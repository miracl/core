...
# set for SSWU plus isogenies
    ...
    if x==25:
        curveset("MDC201601","28","256","1","0","NOT_SPECIAL","0","EDWARDS","1","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
...
# set for SSWU plus isogenies
    ...
    if x==pf+6:
        curveset("BLS12443","29","443","1",["-7","1","1","11","3"],"NOT_SPECIAL","0","WEIERSTRASS","0","BLS12","M_TYPE","POSITIVEX","78","75","128")
        pfcurve_selected=True
