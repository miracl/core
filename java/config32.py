...
# Get Z for G1 and G2
    if isinstance(rz,list) :
        ...
        replace(fpath+"CONFIG_FIELD.java","@RZA@",rz[1])
        replace(fpath+"CONFIG_FIELD.java","@RZB@",rz[2])
    else :
        replace(fpath+"CONFIG_FIELD.java","@RZ@",rz)
        replace(fpath+"CONFIG_FIELD.java","@RZA@","0")
        replace(fpath+"CONFIG_FIELD.java","@RZB@","0")
...
# curve security is AES equivalent, rounded up.
    ...
    if x==1:
        curveset("ED25519","29","255","2","1","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==2:
        curveset("C25519","29","255","2","1","PSEUDO_MERSENNE","0","MONTGOMERY","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==3:
        curveset("NIST256","28","256","1","-10","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")   # Change to 28
        curve_selected=True
    if x==4:
        curveset("BRAINPOOL","28","256","1","-3","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128") # Change to 28
        curve_selected=True
    if x==5:
        curveset("ANSSI","28","256","1","-5","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128") # Change to 28
        curve_selected=True

    if x==6:
        curveset("HIFIVE","29","336","2","1","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","192")
        curve_selected=True
    if x==7:
        curveset("GOLDILOCKS","29","448","1","0","GENERALISED_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True
    if x==8:
        curveset("NIST384","29","384","1","-12","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","192")  # change to 29
        curve_selected=True
    if x==9:
        curveset("C41417","29","414","1","1","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True
    if x==10:
        curveset("NIST521","28","521","1","-4","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True

    if x==11:
        curveset("NUMS256W","28","256","1","7","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==12:
        curveset("NUMS256E","29","256","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==13:
        curveset("NUMS384W","29","384","1","-4","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","192")
        curve_selected=True
    if x==14:
        curveset("NUMS384E","29","384","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","192")
        curve_selected=True
    if x==15:
        curveset("NUMS512W","29","512","1","-4","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True
    if x==16:
        curveset("NUMS512E","29","512","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True
    if x==17:
        curveset("SECP256K1","28","256","1","1","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")   # Change to 28
        curve_selected=True
    if x==18:
        curveset("SM2","28","256","1","-9","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")   # Change to 28
        curve_selected=True



    if x==19:
        curveset("C13318","29","255","2","2","PSEUDO_MERSENNE","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True

    if x==20:
        curveset("JUBJUB","29","255","32","1","NOT_SPECIAL","5","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True

    if x==21:
        curveset("X448","29","448","1","0","GENERALISED_MERSENNE","0","MONTGOMERY","NOT","NOT","NOT","NOT","NOT","256")
        curve_selected=True

    if x==22:
        curveset("SECP160R1","29","160","1","3","NOT_SPECIAL","0","WEIERSTRASS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True

    if x==23:
        curveset("C1174","29","251","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True
    if x==24:
        curveset("C1665","29","166","1","0","PSEUDO_MERSENNE","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True

    if x==25:
        curveset("MDC","28","256","1","0","NOT_SPECIAL","0","EDWARDS","NOT","NOT","NOT","NOT","NOT","128")
        curve_selected=True


    if x==26:
        curveset("BN254","28","254","1",["-1","0","-1"],"NOT_SPECIAL","0","WEIERSTRASS","BN","D_TYPE","NEGATIVEX","71","66","128")
        pfcurve_selected=True
    if x==27:
        curveset("BN254CX","28","254","1",["-1","0","-1"],"NOT_SPECIAL","0","WEIERSTRASS","BN","D_TYPE","NEGATIVEX","76","66","128")
        pfcurve_selected=True
    if x==28:
        curveset("BLS12383","29","383","1",["1","0","1"],"NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","68","65","128")
        pfcurve_selected=True

    if x==29:
        curveset("BLS12381","29","381","1",["-3","0","1"],"NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","69","65","128")
        pfcurve_selected=True


    if x==30:
        curveset("FP256BN","28","256","1",["1","0","1"],"NOT_SPECIAL","0","WEIERSTRASS","BN","M_TYPE","NEGATIVEX","83","66","128")
        pfcurve_selected=True
    if x==31:
        curveset("FP512BN","29","512","1",["1","0","-1"],"NOT_SPECIAL","0","WEIERSTRASS","BN","M_TYPE","POSITIVEX","172","130","128")
        pfcurve_selected=True
# https://eprint.iacr.org/2017/334.pdf
    if x==32:
        curveset("BLS12461","28","461","1",["1","4","1"],"NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX","79","78","128")
        pfcurve_selected=True

    if x==33:
        curveset("BN462","28","462","1",["1","0","-1"],"NOT_SPECIAL","1","WEIERSTRASS","BN","D_TYPE","POSITIVEX","125","118","128")
        pfcurve_selected=True

    if x==34:
        curveset("BLS24479","29","479","1",["1","1","1"],"NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","52","49","192")
        pfcurve_selected=True
    if x==35:
        curveset("BLS48556","29","556","1",["-1","1","1"],"NOT_SPECIAL","0","WEIERSTRASS","BLS","M_TYPE","POSITIVEX","35","32","256")
        pfcurve_selected=True

    if x==36:
        curveset("BLS48581","29","581","1",["2","1","1"],"NOT_SPECIAL","10","WEIERSTRASS","BLS","D_TYPE","NEGATIVEX","36","33","256")
        pfcurve_selected=True
