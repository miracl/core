...
public class TestMPIN256 extends TestCase { //
    ...
    public static void testMPIN() {
        ...
        String dst = "XXXG1_XMD:SHA-512_SVDW_NU_MPIN";
...
// Create Client Identity 
            ...
            MPIN256.ENCODE_TO_CURVE(DST,CLIENT_ID,HCID);
...
// Server is issued secret by TA
 ...
 //       System.out.print("Server Secret SS: 0x");  printBinary(SST);
        ...
        /* Client extracts PIN from secret to create Token */
            ...
            int rtn = MPIN256.EXTRACT_PIN(HCID, pin, TOKEN);
            if (rtn != 0)
...
// Server Second pass. Inputs H(CLIENT_ID), Y, -(x+y)*SEC, U and Server secret SST. 
                    ...
                    rtn = MPIN256.SERVER(HSID, Y, SST,U, SEC);
